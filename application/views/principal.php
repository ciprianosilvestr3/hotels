...
<head>
<meta charset="utf-8" />
<title>Creando DM | Bienvenido</title>
        ...
        <div class="page-container"> 
          <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " id="ulmenu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
...
<![endif]-->
        ...
        <!-- END THEME LAYOUT SCRIPTS -->
           ...
           <!-- srcipts para paginas -->

            <script src="<?=base_url(); ?>assets/paginas/principal.js" type="text/javascript"></script>
